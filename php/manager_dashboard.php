                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    foreach ($claims as $claim) {
                        ...
                        if ($claim['status'] == 'Pending') {
                            ...
                            // Blocks - first one is for approve, second one is for reject
                            ...
                            echo "<div class='badges'> <button class='red'>Rejected</button> </div>"; //TODO :: Is this supposed to be red? Not implemented atm
                            echo "<button onclick=\"window.location.href='view_claim.php?id=" . $claim['claimId'] . "'\">View Claim</button>";
