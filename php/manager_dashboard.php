...
<body>
    <div class="container">
        ...
        <section class="weather-map">
            ...
            <div class="report">
                <h4>Claim 1 </span></h4> 
                <p>[Placeholder for summary of claim]</p>
                <div class="badges"> <button class="blue">Approval Required</button> </div>
                <button>Accept Claim</button> <button>Reject Claim</button> <button>View Claim</button>
            </div>
            <div class="report">
                <h4> Claim 2 </span></h4>
                <p>[Placeholder for summary of claim]</p>
